...
VALUES (sqlc.arg('source_id'), sqlc.arg('campaign_source_id'), sqlc.arg('segment_source_id'), sqlc.narg('history_definition_id'), sqlc.narg('current_campaign_id'), sqlc.arg('source_parent_state'), sqlc.arg('step_index'), sqlc.arg('day_offset'), sqlc.arg('send_time'), sqlc.arg('timezone'), sqlc.arg('content_masked'), sqlc.arg('stop_on_reply'), sqlc.arg('skip_recent_days'), sqlc.arg('created_at'), sqlc.arg('updated_at'), sqlc.arg('original_disposition'), sqlc.arg('original_reason'), sqlc.arg('content_digest'), sqlc.arg('private_digest'), sqlc.arg('source_key_digest'), sqlc.arg('source_payload_digest'), sqlc.arg('source_field_digest'), sqlc.arg('redacted_roots'))
RETURNING *;
