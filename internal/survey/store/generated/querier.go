...
type Querier interface {
	...
	CountSurveyExternalPushLogs(ctx context.Context, questionnaireID pgtype.Int8) (int64, error)
	...
	LockSurveyExternalPushUnknownAttempt(ctx context.Context, arg LockSurveyExternalPushUnknownAttemptParams) (int64, error)
