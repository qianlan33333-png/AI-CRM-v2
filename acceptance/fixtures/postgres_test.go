...
func TestValidateDatabaseURLForDedicatedTemporaryDatabases(t *testing.T) {
	t.Parallel()
	for _, databaseName := range []string{H01A1DatabaseName, H03DatabaseName, I01BDatabaseName, F01ADatabaseName, F01ABDatabaseName, F01PublicDatabaseName, SurveyPushDatabaseName, AutomationAgentsABDatabaseName, AdminOpsABDatabaseName, C01ChannelDatabaseName, J01CouponDatabaseName, CouponABDatabaseName, I03OrderDatabaseName, OrderABDatabaseName, MessageArchiveDatabaseName, PushCenterDatabaseName, MiniProgramLibraryDatabaseName, ImageUpdateDatabaseName, AttachmentLibraryDatabaseName, HXCSenderDatabaseName, ContactPolicyDatabaseName, OutboundCampaignHandoffDatabaseName, SegmentCRUDDatabaseName, EE01DatabaseName, AutomationRulesDatabaseName, StatsL01DatabaseName, AuthA01DatabaseName, AuthSI00BDatabaseName, I01AProductDatabaseName, MediaContentDeliveryDatabaseName, Audience84DatabaseName} {
