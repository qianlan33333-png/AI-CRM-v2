...
func TestCandidateServerIsNotTheRuntimeServer(t *testing.T) {
	...
	assertMethodNames(t, "candidate server", reflect.TypeOf((*generated.StrictServerInterface)(nil)).Elem(), []string{
		"AddCustomerTag", "ApproveIdentityMergeReview", "ArchiveSegment", "ArchiveStage", "ArchiveTag", "ArchiveTagGroup", "BindIdentity", "CopyLegacyWechatPayProduct", "CreateProduct", "CreateSegment", "CreateStage", "CreateTag", "CreateTagGroup", "DeleteLegacyWechatPayProduct", "DisableLegacyWechatPayProduct", "DisableQuestionnairePublicDefinition", "EnableLegacyWechatPayProduct", "GetAdminConfigOverview", "GetAuthSession",
		"GetCustomer", "GetCustomerActivityAnalytics", "GetCustomerContext", "GetDomainVerificationFile", "GetLegacyExecutionRuntime", "GetLegacyExecutionRuntimePage", "GetLegacyExecutionTimeline", "GetLegacyHealth", "GetLegacyPushCenterSections", "GetLegacyPushCenterStats", "GetLegacyWechatPayProductShare", "GetProduct", "GetProductLocalEntitlement", "GetPublicSurveyDefinition", "GetPublicSurveyPage", "GetQuestionnairePublicAnalytics", "GetSegment", "GrantProductLocalEntitlement", "IngestIdentityEvent", "ListAutomationTriggerRuns", "ListCustomerChatActivity", "ListCustomerEvents", "ListCustomerMergeHistory", "ListCustomers", "ListIdentityMergeReviews",
		"ListProductLocalEntitlements", "ListProducts", "ListSegmentMembers", "ListSegments", "ListStages", "ListTagGroups", "ListTags", "LogoutAdmin", "PublishQuestionnairePublicDefinition", "QueryPublicSurveySubmissionResult", "RejectIdentityMergeReview",
		"RemoveCustomerTag", "RenameStage", "ReorderStages", "ReorderTagGroups", "ReorderTags", "RequestSegmentRefresh", "ResolveIdentity", "RevokeProductLocalEntitlement", "SetCustomerStage", "SubmitPublicSurvey", "UpdateCustomer", "UpdateProduct", "UpdateSegment", "UpdateTag", "UpdateTagGroup",
	})
}
