...
export const CAPABILITIES: readonly Capability[] = [
  ...
  { surface: 'admin', screen: 'questionnaireOps', action: '测试或执行外部推送', state: 'backend_blocked', reason: '本任务禁止执行真实外部推送；页面只保存本地 configuration reference 并读取日志' },
