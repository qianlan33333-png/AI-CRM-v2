...
base_database_url="$P4SI00B_AUTH_TEST_DATABASE_URL"
temporary_database="aicrm_test_p4_auth_si00b"
...
printf 'SI00B Auth migration compatibility: PASS (CorpID accounts and existing session preserved across rollback and latest upgrade)\n'
