...
func TestCandidateServerIsNotTheRuntimeServer(t *testing.T) {
	...
	assertMethodNames(t, "candidate server", reflect.TypeOf((*generated.StrictServerInterface)(nil)).Elem(), []string{
		"AddCustomerTag", "ApproveIdentityMergeReview", "ArchiveSegment", "ArchiveServicePeriodProduct", "ArchiveStage", "ArchiveTag", "ArchiveTagGroup", "BindIdentity", "CopyLegacyWechatPayProduct", "CopyServicePeriodProduct", "CreateProduct", "CreateSegment", "CreateServicePeriodMemberGridCollaborator", "CreateServicePeriodMemberView", "CreateServicePeriodProduct", "CreateStage", "CreateTag", "CreateTagGroup", "DeleteLegacyWechatPayProduct", "DeleteServicePeriodMemberGridCollaborator", "DeleteServicePeriodMemberView", "DisableLegacyWechatPayProduct", "DisableQuestionnairePublicDefinition", "DisableServicePeriodProduct", "EnableLegacyWechatPayProduct", "EnableServicePeriodProduct", "GetAdminConfigOverview", "GetAuthSession",
		"GetCustomer", "GetCustomerActivityAnalytics", "GetCustomerContext", "GetDomainVerificationFile", "GetLegacyExecutionRuntime", "GetLegacyExecutionRuntimePage", "GetLegacyExecutionTimeline", "GetLegacyHealth", "GetLegacyPushCenterSections", "GetLegacyPushCenterStats", "GetLegacyWechatPayProductShare", "GetProduct", "GetProductLocalEntitlement", "GetPublicSurveyDefinition", "GetPublicSurveyPage", "GetQuestionnairePublicAnalytics", "GetSegment", "GetServicePeriodMemberGridAccess", "GetServicePeriodMemberGridSchema", "GetServicePeriodMemberGridShareSettings", "GetServicePeriodProduct", "GrantProductLocalEntitlement", "IngestIdentityEvent", "ListAutomationTriggerRuns", "ListCustomerChatActivity", "ListCustomerEvents", "ListCustomerMergeHistory", "ListCustomerSurveyAnswers", "ListCustomers", "ListIdentityMergeReviews",
		"ListProductLocalEntitlements", "ListProducts", "ListSegmentMembers", "ListSegments", "ListServicePeriodMemberViews", "ListServicePeriodProducts", "ListStages", "ListTagGroups", "ListTags", "LogoutAdmin", "PublishQuestionnairePublicDefinition", "QueryPublicSurveySubmissionResult", "QueryServicePeriodMemberGrid", "RejectIdentityMergeReview",
		"RemoveCustomerTag", "RenameStage", "ReorderStages", "ReorderTagGroups", "ReorderTags", "RequestSegmentRefresh", "ResolveIdentity", "RevokeProductLocalEntitlement", "SetCustomerStage", "SubmitPublicSurvey", "UpdateCustomer", "UpdateProduct", "UpdateSegment", "UpdateServicePeriodMemberGridCollaborator", "UpdateServicePeriodMemberView", "UpdateServicePeriodProduct", "UpdateTag", "UpdateTagGroup",
	})
}
