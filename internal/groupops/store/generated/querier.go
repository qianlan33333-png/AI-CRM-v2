...
type Querier interface {
	...
	CountGroupOpsHistoricalDirectory(ctx context.Context) (int64, error)
	CountGroupOpsHistoricalGroups(ctx context.Context, planID int64) (int64, error)
	CountGroupOpsHistoricalNodes(ctx context.Context, planID int64) (int64, error)
	CountGroupOpsHistoricalPlans(ctx context.Context) (int64, error)
	CountGroupOpsPlans(ctx context.Context) (int64, error)
	CreateGroupOpsHistoricalDirectory(ctx context.Context, arg CreateGroupOpsHistoricalDirectoryParams) (GroupOpsV1HistoryDirectory, error)
	CreateGroupOpsHistoricalGroup(ctx context.Context, arg CreateGroupOpsHistoricalGroupParams) (GroupOpsV1HistoryGroup, error)
	CreateGroupOpsHistoricalNode(ctx context.Context, arg CreateGroupOpsHistoricalNodeParams) (GroupOpsV1HistoryNode, error)
	CreateGroupOpsHistoricalPlanMarker(ctx context.Context, arg CreateGroupOpsHistoricalPlanMarkerParams) (GroupOpsV1HistoryPlan, error)
	...
	GetGroupOpsHistoricalDirectory(ctx context.Context, id int64) (GroupOpsV1HistoryDirectory, error)
	GetGroupOpsHistoricalGroup(ctx context.Context, id int64) (GroupOpsV1HistoryGroup, error)
	GetGroupOpsHistoricalNode(ctx context.Context, id int64) (GroupOpsV1HistoryNode, error)
	GetGroupOpsHistoricalPlan(ctx context.Context, id int64) (GetGroupOpsHistoricalPlanRow, error)
	...
	ListGroupOpsHistoricalDirectory(ctx context.Context, arg ListGroupOpsHistoricalDirectoryParams) ([]GroupOpsV1HistoryDirectory, error)
	ListGroupOpsHistoricalGroups(ctx context.Context, arg ListGroupOpsHistoricalGroupsParams) ([]GroupOpsV1HistoryGroup, error)
	ListGroupOpsHistoricalNodes(ctx context.Context, arg ListGroupOpsHistoricalNodesParams) ([]GroupOpsV1HistoryNode, error)
	ListGroupOpsHistoricalPlans(ctx context.Context, arg ListGroupOpsHistoricalPlansParams) ([]ListGroupOpsHistoricalPlansRow, error)
