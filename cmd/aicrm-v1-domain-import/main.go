...
func validDomain(value string) bool {
	if value == deferredIdentityHistoryDomain || value == campaignDefinitionHistoryDomain || value == "contact-reference-history" {
		return true
	}
