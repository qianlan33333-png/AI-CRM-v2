...
type Querier interface {
	...
	CreateHistoricalOrder(ctx context.Context, arg CreateHistoricalOrderParams) (CreateHistoricalOrderRow, error)
	CreateHistoricalRefund(ctx context.Context, arg CreateHistoricalRefundParams) (OrderHistoricalRefund, error)
	...
	GetHistoricalOrder(ctx context.Context, id int64) (GetHistoricalOrderRow, error)
	GetHistoricalRefund(ctx context.Context, id int64) (OrderHistoricalRefund, error)
	...
	ListHistoricalOrderRefunds(ctx context.Context, orderID int64) ([]OrderHistoricalRefund, error)
