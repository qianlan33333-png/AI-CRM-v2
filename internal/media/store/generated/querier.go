...
type Querier interface {
	...
	CompleteMediaContentPackageMutation(ctx context.Context, arg CompleteMediaContentPackageMutationParams) (MediaContentPackageMutationReceipt, error)
	...
	CreateHistoricalInvalidAsset(ctx context.Context, arg CreateHistoricalInvalidAssetParams) (MediaV1InvalidAssetHistory, error)
	...
	GetHistoricalInvalidAsset(ctx context.Context, id int64) (MediaV1InvalidAssetHistory, error)
	...
	GetMediaContentPackageMutation(ctx context.Context, arg GetMediaContentPackageMutationParams) (MediaContentPackageMutationReceipt, error)
	...
	ListHistoricalInvalidAsset(ctx context.Context, arg ListHistoricalInvalidAssetParams) ([]MediaV1InvalidAssetHistory, error)
	...
	LockGroupOpsAttachmentSource(ctx context.Context, attachmentID int64) (LockGroupOpsAttachmentSourceRow, error)
	...
	ReserveMediaContentPackageMutation(ctx context.Context, arg ReserveMediaContentPackageMutationParams) (MediaContentPackageMutationReceipt, error)
