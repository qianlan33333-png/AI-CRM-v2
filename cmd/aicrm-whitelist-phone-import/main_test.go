...
func TestReadSourceProducesStableDigestWithoutReturningRawRows(t *testing.T) {
	first := "unionid,primary_external_userid,mobile_normalized,mobile_verified,mobile_source,updated_at\nunion-b,external-b,13900000000,t,sidebar_bind,2026-08-30T00:00:00Z\nunion-a,external-a,13800000000,true,mobile_bind,2026-08-29T00:00:00Z\n"
	second := "unionid,primary_external_userid,mobile_normalized,mobile_verified,mobile_source,updated_at\nunion-a,external-a,13800000000,true,mobile_bind,2026-08-29T00:00:00Z\nunion-b,external-b,13900000000,t,sidebar_bind,2026-08-30T00:00:00Z\n"
...
func TestReadSourceRejectsDuplicateUnionIDAndInvalidShape(t *testing.T) {
	duplicate := "unionid,primary_external_userid,mobile_normalized,mobile_verified,mobile_source,updated_at\nu,e1,13800000000,t,a,x\nu,e2,13900000000,t,b,y\n"
	if _, _, err := readSource(strings.NewReader(duplicate)); err == nil {
		t.Fatal("duplicate unionid accepted")
	}
	badHeader := "mobile,unionid,external_userid,verified,source,updated_at\n13800000000,u,e,t,a,x\n"
	if _, _, err := readSource(strings.NewReader(badHeader)); err == nil {
		t.Fatal("bad header accepted")
	}
}

func TestReadSourceRejectsDuplicateExternalUserID(t *testing.T) {
	input := "unionid,primary_external_userid,mobile_normalized,mobile_verified,mobile_source,updated_at\n" +
		"union-a,external-a,13800000000,true,mobile_bind,2026-08-29T00:00:00Z\n" +
		"union-b,external-a,13900000000,true,mobile_bind,2026-08-30T00:00:00Z\n"
	if _, _, err := readSource(strings.NewReader(input)); err == nil {
		t.Fatal("duplicate external_userid accepted")
	}
}
