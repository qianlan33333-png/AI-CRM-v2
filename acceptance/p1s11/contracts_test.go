...
func TestCandidateServerIsNotTheRuntimeServer(t *testing.T) {
	...
	assertMethodNames(t, "candidate server", reflect.TypeOf((*generated.StrictServerInterface)(nil)).Elem(), []string{
		...
		"ListLegacyChannelEntrants", "ListLegacyChannels", "ListProductLocalEntitlements", "ListProducts", "ListSegmentMembers", "ListSegments", "ListServicePeriodMemberViews", "ListServicePeriodProducts", "ListStages", "ListTagGroups", "ListTags", "LogoutAdmin", "PublishQuestionnairePublicDefinition", "QueryPublicSurveySubmissionResult", "QueryServicePeriodMemberGrid", "RejectIdentityMergeReview",
		"RemoveCustomerTag", "RenameStage", "ReorderStages", "ReorderTagGroups", "ReorderTags", "RequestSegmentRefresh", "ResolveIdentity", "RevokeProductLocalEntitlement", "SetCustomerStage", "SubmitPublicSurvey", "UpdateCustomer", "UpdateLegacyChannel", "UpdateProduct", "UpdateSegment", "UpdateServicePeriodMemberGridCollaborator", "UpdateServicePeriodMemberView", "UpdateServicePeriodProduct", "UpdateTag", "UpdateTagGroup",
	})
}
