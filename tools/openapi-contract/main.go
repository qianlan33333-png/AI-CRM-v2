...
var nativePackageOperations = map[string]nativePackageOperation{
	...
	"getServicePeriodProductExternalPush":       {"/api/admin/service-period-products/{product_id}/external-push", "GET", p4CommerceExternalPushEvidence, "products.read", "human_session", "financial", "product.external_push.local_configuration", "none", map[string]string{"admin": "global", "ops": "global"}},
	"saveServicePeriodProductExternalPush":      {"/api/admin/service-period-products/{product_id}/external-push", "PUT", p4CommerceExternalPushEvidence, "products.write", "human_session", "financial", "product.external_push.local_configuration", "required", map[string]string{"admin": "global", "ops": "global"}},
	"queueServicePeriodProductExternalPushTest": {"/api/admin/service-period-products/{product_id}/external-push/test", "POST", p4CommerceExternalPushEvidence, "products.write", "human_session", "financial", "product.external_push.local_accepted_effect", "required", map[string]string{"admin": "global", "ops": "global"}},
