...
func sourceModule(rel string) string {
	...
	if len(parts) == 3 && parts[0] == "acceptance" {
		switch parts[1] {
		case "contactfixture":
			return "contact"
...
func checkWeCom(text, source, rel string) error {
	...
	outboundWrite := map[string]bool{"message/send": true, "media/upload": true, "externalcontact/add_msg_template": true, "externalcontact/remind_groupmsg_send": true, "externalcontact/add_contact_way": true, "externalcontact/update_contact_way": true, "externalcontact/del_contact_way": true, "externalcontact/mark_tag": true, "externalcontact/remark": true}
	wechatShopWrite := map[string]bool{"stable_token": true}
	wecomWrite := map[string]bool{"externalcontact/add_contact_way": true, "externalcontact/customer_acquisition/create_link": true, "externalcontact/customer_acquisition/update_link": true, "externalcontact/customer_acquisition/delete_link": true}
	wecomRead := map[string]bool{"gettoken": true, "get_jsapi_ticket": true, "auth/getuserinfo": true, "ticket/get": true, "externalcontact/get": true, "externalcontact/list": true, "externalcontact/batch/get_by_user": true, "externalcontact/get_follow_user_list": true, "externalcontact/groupchat/get": true, "externalcontact/groupchat/list": true, "externalcontact/get_corp_tag_list": true, "externalcontact/get_contact_way": true, "externalcontact/list_contact_way": true, "externalcontact/customer_acquisition/get": true, "externalcontact/customer_acquisition/list_link": true, "externalcontact/get_groupmsg_task": true, "externalcontact/get_groupmsg_send_result": true}
