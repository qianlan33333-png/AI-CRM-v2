...
type Querier interface {
	...
	CountHistoricalBroadcastJobs(ctx context.Context) (int64, error)
	CountHistoricalOutboundTasks(ctx context.Context) (int64, error)
	...
	CreateHistoricalBroadcastJob(ctx context.Context, arg CreateHistoricalBroadcastJobParams) (OutboundV1BroadcastJobHistory, error)
	CreateHistoricalOutboundTask(ctx context.Context, arg CreateHistoricalOutboundTaskParams) (OutboundV1TaskHistory, error)
	...
	GetHistoricalBroadcastJob(ctx context.Context, id int64) (OutboundV1BroadcastJobHistory, error)
	GetHistoricalOutboundTask(ctx context.Context, id int64) (OutboundV1TaskHistory, error)
	...
	LookupOutboundTaskHistoryParents(ctx context.Context, sourceID int64) ([]LookupOutboundTaskHistoryParentsRow, error)
