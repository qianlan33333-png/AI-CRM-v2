...
func TestRadarClickHistoryImporterPreservesFactsAndReplays(t *testing.T) {
	...
	if string(encoded) == "" || radarClickContainsAny(string(encoded), "union-private", "ip-private", "query-private") {
...
func radarClickContainsAny(value string, candidates ...string) bool {
