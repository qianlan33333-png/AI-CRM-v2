...
func (service *Service) query(ctx context.Context, input QueryInput) (QueryResponse, error) {
	...
	if selection == defaultQuerySelection() || (selection == querySelection{Sort: querySortUpdatedAtDesc, GroupBy: queryGroupNone, ViewID: "default"}) {
		return service.queryDefault(ctx, input)
	}
	return service.querySelected(ctx, input, selection)
}

func (service *Service) queryDefault(ctx context.Context, input QueryInput) (QueryResponse, error) {
