...
require_caddy $'\t@backend path /api/* /auth/* /wecom/* /oauth/* /q/* /c/* /p/* /r/* /admin/questionnaires/external-push-logs /admin/questionnaires/*/external-push-logs /login /logout /healthz /readyz'
