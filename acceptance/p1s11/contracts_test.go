...
func TestCandidateServerIsNotTheRuntimeServer(t *testing.T) {
	...
	assertMethodNames(t, "candidate server", reflect.TypeOf((*generated.StrictServerInterface)(nil)).Elem(), []string{
		...
		"ListCustomerTimelineHistoryEvents", "GetCustomerTimelineHistoryEvent",
		...
		"DispatchOutboundCampaignHandoff", "DispatchOutboundCampaignRecipient", "GetOutboundCampaignDispatchReconciliation", "ReconcileOutboundCampaignDispatch",
		"CreateCloudCampaignTouchPlan", "GetCloudCampaignTouchPlan", "ListCloudCampaignMembers", "ListCloudCampaignPlans", "ListCloudCampaignTouchPlans", "GetCloudCampaignTouchPlanRecipient", "GetCloudCampaignTouchPlanRecipientReview", "GetCloudCampaignTouchPlanReview", "ListCloudCampaignTouchPlanRecipients", "ListCloudOrchestratorAudit", "MutateCloudCampaignTouchPlanRecipientReview", "MutateCloudCampaignTouchPlanReview",
		"BootstrapSidebar", "MintSidebarContext", "GetSidebarWorkbench", "UpdateSidebarProfile", "BindSidebarPhone", "ListSidebarQuestionnaires", "ListSidebarOrders", "ListSidebarPeriodicOrders", "UpdateSidebarPeriodicRemark", "ListSidebarMaterials", "ListSidebarShareableProducts", "PrepareSidebarImageTemporaryMedia", "GetSidebarMaterialThumbnailStatus", "GetSidebarMaterialThumbnailPreview", "StartSidebarOAuth", "CompleteSidebarOAuth", "GetSidebarAgentConfig", "ListSidebarTimeline", "ListSidebarChatActivity", "ListSidebarOtherStaffChats",
