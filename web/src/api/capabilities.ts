...
export const CAPABILITIES: readonly Capability[] = [
  ...
  { surface: 'admin', screen: 'products/productForm', action: '普通商品分享读取、二维码与链接预览', state: 'real', operation: 'getLegacyWechatPayProductShare', reason: '只返回已启用商品的同源只读详情页，不声明 checkout、支付或 Provider 可用' },
