...
func TestCandidateServerIsNotTheRuntimeServer(t *testing.T) {
	...
	assertMethodNames(t, "candidate server", reflect.TypeOf((*generated.StrictServerInterface)(nil)).Elem(), []string{
		"AddCustomerTag", "ApproveIdentityMergeReview", "ArchiveSegment", "ArchiveStage", "ArchiveTag", "ArchiveTagGroup", "BindIdentity", "CreateProduct", "CreateSegment", "CreateStage", "CreateTag", "CreateTagGroup", "DisableQuestionnairePublicDefinition", "GetAdminConfigOverview", "GetAuthSession",
		"GetCustomer", "GetCustomerActivityAnalytics", "GetCustomerContext", "GetDomainVerificationFile", "GetLegacyExecutionRuntime", "GetLegacyExecutionRuntimePage", "GetLegacyExecutionTimeline", "GetLegacyHealth", "GetLegacyPushCenterSections", "GetLegacyPushCenterStats", "GetProduct", "GetProductLocalEntitlement", "GetPublicSurveyDefinition", "GetPublicSurveyPage", "GetQuestionnairePublicAnalytics", "GetSegment", "GrantProductLocalEntitlement", "IngestIdentityEvent", "ListAutomationTriggerRuns", "ListCustomerChatActivity", "ListCustomerEvents", "ListCustomerMergeHistory", "ListCustomers", "ListIdentityMergeReviews",
