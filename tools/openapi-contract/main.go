...
const (
	...
	p4APIClientOAuthEvidence                   = "W9-S05-062-2026-08-27"
...
var nativePackageOperations = map[string]nativePackageOperation{
	...
	"listUnboundTagHistory":                  {"/api/admin/contact-invalid-history/tags", "GET", "P4-V1-INVALID-SOURCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_invalid_source_history", "none", map[string]string{"admin": "global"}},
	"getUnboundTagHistory":                   {"/api/admin/contact-invalid-history/tags/{history_id}", "GET", "P4-V1-INVALID-SOURCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_invalid_source_history", "none", map[string]string{"admin": "global"}},
	"listInvalidChannelHistory":              {"/api/admin/contact-invalid-history/channels", "GET", "P4-V1-INVALID-SOURCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_invalid_source_history", "none", map[string]string{"admin": "global"}},
	"getInvalidChannelHistory":               {"/api/admin/contact-invalid-history/channels/{history_id}", "GET", "P4-V1-INVALID-SOURCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_invalid_source_history", "none", map[string]string{"admin": "global"}},
	"listInvalidAssetHistory":                {"/api/admin/media-invalid-history", "GET", "P4-V1-INVALID-SOURCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "media.read_only_v1_invalid_source_history", "none", map[string]string{"admin": "global"}},
	"getInvalidAssetHistory":                 {"/api/admin/media-invalid-history/{history_id}", "GET", "P4-V1-INVALID-SOURCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "media.read_only_v1_invalid_source_history", "none", map[string]string{"admin": "global"}},
	"listInvalidRadarLinkHistory":            {"/api/admin/radar-invalid-history", "GET", "P4-V1-INVALID-SOURCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "radar.read_only_v1_invalid_source_history", "none", map[string]string{"admin": "global"}},
	"getInvalidRadarLinkHistory":             {"/api/admin/radar-invalid-history/{history_id}", "GET", "P4-V1-INVALID-SOURCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "radar.read_only_v1_invalid_source_history", "none", map[string]string{"admin": "global"}},
	"listOutboundTaskHistory":                {"/api/admin/outbound-task-history", "GET", "P4-V1-OUTBOUND-TASK-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "outbound.read_only_v1_task_history", "none", map[string]string{"admin": "global"}},
	"getOutboundTaskHistory":                 {"/api/admin/outbound-task-history/{history_id}", "GET", "P4-V1-OUTBOUND-TASK-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "outbound.read_only_v1_task_history", "none", map[string]string{"admin": "global"}},
	...
	"getMarketingStateHistoryChange":         {"/api/admin/marketing-state-history/state-changes/{history_id}", "GET", "P4-V1-MARKETING-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_v1_marketing_state_history", "none", map[string]string{"admin": "global"}},
	"listMarketingStateHistoryValueSnapshot": {"/api/admin/marketing-state-history/value-snapshots", "GET", "P4-V1-MARKETING-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_v1_marketing_state_history", "none", map[string]string{"admin": "global"}},
	"getMarketingStateHistoryValueSnapshot":  {"/api/admin/marketing-state-history/value-snapshots/{history_id}", "GET", "P4-V1-MARKETING-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_v1_marketing_state_history", "none", map[string]string{"admin": "global"}},
	"listMarketingStateHistoryValueChange":   {"/api/admin/marketing-state-history/value-changes", "GET", "P4-V1-MARKETING-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_v1_marketing_state_history", "none", map[string]string{"admin": "global"}},
	"getMarketingStateHistoryValueChange":    {"/api/admin/marketing-state-history/value-changes/{history_id}", "GET", "P4-V1-MARKETING-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_v1_marketing_state_history", "none", map[string]string{"admin": "global"}},

	"listCustomerStateHistorySnapshot":            {"/api/admin/customer-state-history/snapshots", "GET", "P4-V1-CUSTOMER-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_customer_state_history", "none", map[string]string{"admin": "global"}},
	"getCustomerStateHistorySnapshot":             {"/api/admin/customer-state-history/snapshots/{history_id}", "GET", "P4-V1-CUSTOMER-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_customer_state_history", "none", map[string]string{"admin": "global"}},
	"listCustomerStateHistoryChange":              {"/api/admin/customer-state-history/changes", "GET", "P4-V1-CUSTOMER-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_customer_state_history", "none", map[string]string{"admin": "global"}},
	"getCustomerStateHistoryChange":               {"/api/admin/customer-state-history/changes/{history_id}", "GET", "P4-V1-CUSTOMER-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_customer_state_history", "none", map[string]string{"admin": "global"}},
	"listCustomerStateHistoryClassTermTagMapping": {"/api/admin/customer-state-history/term-tag-mappings", "GET", "P4-V1-CUSTOMER-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_customer_state_history", "none", map[string]string{"admin": "global"}},
	"getCustomerStateHistoryClassTermTagMapping":  {"/api/admin/customer-state-history/term-tag-mappings/{history_id}", "GET", "P4-V1-CUSTOMER-STATE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_customer_state_history", "none", map[string]string{"admin": "global"}},

	"listStaticHistoryCycleMetric":              {"/api/admin/static-history/cycle-metrics", "GET", "P4-V1-CYCLE-OBSERVATION-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_observation_history", "none", map[string]string{"admin": "global"}},
	"getStaticHistoryCycleMetric":               {"/api/admin/static-history/cycle-metrics/{history_id}", "GET", "P4-V1-CYCLE-OBSERVATION-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_observation_history", "none", map[string]string{"admin": "global"}},
	"listStaticHistoryCycleReference":           {"/api/admin/static-history/cycle-references", "GET", "P4-V1-CYCLE-OBSERVATION-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_observation_history", "none", map[string]string{"admin": "global"}},
	"getStaticHistoryCycleReference":            {"/api/admin/static-history/cycle-references/{history_id}", "GET", "P4-V1-CYCLE-OBSERVATION-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_observation_history", "none", map[string]string{"admin": "global"}},
	"listStaticHistoryGroupInvite":              {"/api/admin/static-history/group-invites", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "media.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"getStaticHistoryGroupInvite":               {"/api/admin/static-history/group-invites/{history_id}", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "media.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"listStaticHistoryProductPageSlice":         {"/api/admin/static-history/page-slices", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "product.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"getStaticHistoryProductPageSlice":          {"/api/admin/static-history/page-slices/{history_id}", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "product.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"listStaticHistoryCycleStrategy":            {"/api/admin/static-history/cycle-strategies", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"getStaticHistoryCycleStrategy":             {"/api/admin/static-history/cycle-strategies/{history_id}", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"listStaticHistoryCycleVersion":             {"/api/admin/static-history/cycle-versions", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"getStaticHistoryCycleVersion":              {"/api/admin/static-history/cycle-versions/{history_id}", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"listStaticHistoryCycleDocument":            {"/api/admin/static-history/cycle-documents", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"getStaticHistoryCycleDocument":             {"/api/admin/static-history/cycle-documents/{history_id}", "GET", "P4-V1-STATIC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "operationcycle.read_only_v1_static_history", "none", map[string]string{"admin": "global"}},
	"listHXCHistoryMeta":                        {"/api/admin/hxc-history/refreshes", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"getHXCHistoryMeta":                         {"/api/admin/hxc-history/refreshes/{history_id}", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"listHXCHistorySnapshot":                    {"/api/admin/hxc-history/snapshots", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"getHXCHistorySnapshot":                     {"/api/admin/hxc-history/snapshots/{history_id}", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"listHXCHistoryActivation":                  {"/api/admin/hxc-history/activations", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"getHXCHistoryActivation":                   {"/api/admin/hxc-history/activations/{history_id}", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"listHXCHistoryLead":                        {"/api/admin/hxc-history/leads", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"getHXCHistoryLead":                         {"/api/admin/hxc-history/leads/{history_id}", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"listHXCHistoryBatch":                       {"/api/admin/hxc-history/batches", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"getHXCHistoryBatch":                        {"/api/admin/hxc-history/batches/{history_id}", "GET", "P4-V1-HXC-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"listHXCHistorySenderConfig":                {"/api/admin/hxc-history/sender-configs", "GET", "P4-V1-HXC-RUNTIME-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"getHXCHistorySenderConfig":                 {"/api/admin/hxc-history/sender-configs/{history_id}", "GET", "P4-V1-HXC-RUNTIME-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"listHXCHistorySendRecord":                  {"/api/admin/hxc-history/send-records", "GET", "P4-V1-HXC-RUNTIME-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"getHXCHistorySendRecord":                   {"/api/admin/hxc-history/send-records/{history_id}", "GET", "P4-V1-HXC-RUNTIME-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"listHXCHistoryMemberUsage":                 {"/api/admin/hxc-history/member-usage", "GET", "P4-V1-HXC-MEMBER-USAGE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"getHXCHistoryMemberUsage":                  {"/api/admin/hxc-history/member-usage/{history_id}", "GET", "P4-V1-HXC-MEMBER-USAGE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"listHXCHistoryChatJob":                     {"/api/admin/hxc-history/chat-jobs", "GET", "P4-V1-HXC-CHAT-JOB-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"getHXCHistoryChatJob":                      {"/api/admin/hxc-history/chat-jobs/{history_id}", "GET", "P4-V1-HXC-CHAT-JOB-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "hxc.read_only_v1_observations", "none", map[string]string{"admin": "global"}},
	"listProfileHistoryTemplates":               {"/api/admin/profile-catalog-history/templates", "GET", "P4-V1-PROFILE-CATALOG-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_profile_catalog_history", "none", map[string]string{"admin": "global"}},
	"getProfileHistoryTemplate":                 {"/api/admin/profile-catalog-history/templates/{template_id}", "GET", "P4-V1-PROFILE-CATALOG-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_profile_catalog_history", "none", map[string]string{"admin": "global"}},
	"listProfileHistoryCategories":              {"/api/admin/profile-catalog-history/templates/{template_id}/categories", "GET", "P4-V1-PROFILE-CATALOG-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_profile_catalog_history", "none", map[string]string{"admin": "global"}},
	"listProfileHistoryOptionMappings":          {"/api/admin/profile-catalog-history/templates/{template_id}/categories/{category_id}/option-mappings", "GET", "P4-V1-PROFILE-CATALOG-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_profile_catalog_history", "none", map[string]string{"admin": "global"}},
	"listSignupTagHistoryRules":                 {"/api/admin/profile-catalog-history/signup-tag-rules", "GET", "P4-V1-PROFILE-CATALOG-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_profile_catalog_history", "none", map[string]string{"admin": "global"}},
	"listRadarClickHistory":                     {"/api/admin/radar-click-history", "GET", "P4-V1-RADAR-CLICK-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "radar.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getRadarClickHistory":                      {"/api/admin/radar-click-history/{history_id}", "GET", "P4-V1-RADAR-CLICK-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "radar.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listMarketingConfigHistoryConfigs":         {"/api/admin/marketing-config-history/configs", "GET", "P4-V1-MARKETING-CONFIG-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "automation.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getMarketingConfigHistoryConfig":           {"/api/admin/marketing-config-history/configs/{history_id}", "GET", "P4-V1-MARKETING-CONFIG-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "automation.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listMarketingConfigHistoryRules":           {"/api/admin/marketing-config-history/rules", "GET", "P4-V1-MARKETING-CONFIG-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "automation.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getMarketingConfigHistoryRule":             {"/api/admin/marketing-config-history/rules/{history_id}", "GET", "P4-V1-MARKETING-CONFIG-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "automation.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	...
	"getAutomationHistoryConfig":                {"/api/admin/automation-history/configs/{history_id}", "GET", "P4-V1-AUTOMATION-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "automation.read_only_v1_configuration_history", "none", map[string]string{"admin": "global"}},
	"listAutomationHistoryPrompts":              {"/api/admin/automation-history/prompts", "GET", "P4-V1-AUTOMATION-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "automation.read_only_v1_configuration_history", "none", map[string]string{"admin": "global"}},
	"getAutomationHistoryPrompt":                {"/api/admin/automation-history/prompts/{history_id}", "GET", "P4-V1-AUTOMATION-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "automation.read_only_v1_configuration_history", "none", map[string]string{"admin": "global"}},
	"listAutomationHistoryAgents":               {"/api/admin/automation-history/agents", "GET", "P4-V1-AUTOMATION-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "automation.read_only_v1_configuration_history", "none", map[string]string{"admin": "global"}},
	"getAutomationHistoryAgent":                 {"/api/admin/automation-history/agents/{history_id}", "GET", "P4-V1-AUTOMATION-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "automation.read_only_v1_configuration_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistoryGroups":                 {"/api/admin/audience-history/groups", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistoryActivityRuns":           {"/api/admin/audience-history/activity-runs", "GET", "P4-V1-AUDIENCE-ACTIVITY-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_activity_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistoryActivityMemberEvents":   {"/api/admin/audience-history/activity-member-events", "GET", "P4-V1-AUDIENCE-ACTIVITY-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_activity_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistoryPackages":               {"/api/admin/audience-history/packages", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistoryVersions":               {"/api/admin/audience-history/packages/{package_id}/versions", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistorySenders":                {"/api/admin/audience-history/packages/{package_id}/senders", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistoryRules":                  {"/api/admin/audience-history/rules", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistoryRuleVersions":           {"/api/admin/audience-history/rules/{rule_id}/versions", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistoryDefinitions":            {"/api/admin/audience-history/definitions", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"listAudienceHistoryMembers":                {"/api/admin/audience-history/packages/{package_id}/members", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"getAudienceHistoryPackage":                 {"/api/admin/audience-history/packages/{package_id}", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"getAudienceHistoryDefinition":              {"/api/admin/audience-history/definitions/{definition_id}", "GET", "P4-V1-AUDIENCE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "segment.read_only_audience_history", "none", map[string]string{"admin": "global"}},
	"listMemberViewHistory":                     {"/api/admin/member-grid-history/views", "GET", "P4-V1-MEMBER-GRID-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "product.read_only_v1_member_grid_history", "none", map[string]string{"admin": "global"}},
	"getMemberViewHistory":                      {"/api/admin/member-grid-history/views/{history_id}", "GET", "P4-V1-MEMBER-GRID-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "product.read_only_v1_member_grid_history", "none", map[string]string{"admin": "global"}},
	"listMemberUsageHistory":                    {"/api/admin/member-grid-history/usage", "GET", "P4-V1-MEMBER-GRID-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "product.read_only_v1_member_grid_history", "none", map[string]string{"admin": "global"}},
	"getMemberUsageHistory":                     {"/api/admin/member-grid-history/usage/{history_id}", "GET", "P4-V1-MEMBER-GRID-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "product.read_only_v1_member_grid_history", "none", map[string]string{"admin": "global"}},
	"listSidebarProfileHistory":                 {"/api/admin/contact-history/sidebar-profiles", "GET", "P4-V1-CONTACT-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_contact_history", "none", map[string]string{"admin": "global"}},
	"getSidebarProfileHistory":                  {"/api/admin/contact-history/sidebar-profiles/{history_id}", "GET", "P4-V1-CONTACT-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_contact_history", "none", map[string]string{"admin": "global"}},
	"listOwnerMigrationResultHistory":           {"/api/admin/contact-history/owner-migration-results", "GET", "P4-V1-CONTACT-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_contact_history", "none", map[string]string{"admin": "global"}},
	"getOwnerMigrationResultHistory":            {"/api/admin/contact-history/owner-migration-results/{history_id}", "GET", "P4-V1-CONTACT-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_contact_history", "none", map[string]string{"admin": "global"}},
	"listCampaignHistorySegments":               {"/api/admin/campaign-history/segments", "GET", "P4-V1-CAMPAIGN-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listDeferredPeople":                        {"/api/admin/deferred-identity-history/people", "GET", "P4-V1-DEFERRED-IDENTITY-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getDeferredPerson":                         {"/api/admin/deferred-identity-history/people/{history_id}", "GET", "P4-V1-DEFERRED-IDENTITY-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listDeferredIdentityConflicts":             {"/api/admin/deferred-identity-history/conflicts", "GET", "P4-V1-DEFERRED-IDENTITY-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getDeferredIdentityConflict":               {"/api/admin/deferred-identity-history/conflicts/{history_id}", "GET", "P4-V1-DEFERRED-IDENTITY-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listMissingRootIdentities":                 {"/api/admin/deferred-identity-history/missing-roots", "GET", "P4-V1-DEFERRED-IDENTITY-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getMissingRootIdentity":                    {"/api/admin/deferred-identity-history/missing-roots/{history_id}", "GET", "P4-V1-DEFERRED-IDENTITY-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listCampaignHistoryDefinitions":            {"/api/admin/campaign-history/definitions", "GET", "P4-V1-CAMPAIGN-DEFINITION-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getCampaignHistoryDefinition":              {"/api/admin/campaign-history/definitions/{history_id}", "GET", "P4-V1-CAMPAIGN-DEFINITION-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listCampaignHistoryDefinitionSteps":        {"/api/admin/campaign-history/definition-steps", "GET", "P4-V1-CAMPAIGN-DEFINITION-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listWeComContactHistoryEvents":             {"/api/admin/wecom-contact-history/events", "GET", "P4-V1-WECOM-CONTACT-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getWeComContactHistoryEvent":               {"/api/admin/wecom-contact-history/events/{history_id}", "GET", "P4-V1-WECOM-CONTACT-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listWeComContactHistoryRelations":          {"/api/admin/wecom-contact-history/relations", "GET", "P4-V1-WECOM-CONTACT-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getWeComContactHistoryRelation":            {"/api/admin/wecom-contact-history/relations/{history_id}", "GET", "P4-V1-WECOM-CONTACT-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listContactReferenceHistoryBindings":       {"/api/admin/wecom-contact-history/bindings", "GET", "P4-V1-CONTACT-REFERENCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getContactReferenceHistoryBinding":         {"/api/admin/wecom-contact-history/bindings/{history_id}", "GET", "P4-V1-CONTACT-REFERENCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listContactReferenceHistoryDirectory":      {"/api/admin/wecom-contact-history/directory", "GET", "P4-V1-CONTACT-REFERENCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getContactReferenceHistoryDirectory":       {"/api/admin/wecom-contact-history/directory/{history_id}", "GET", "P4-V1-CONTACT-REFERENCE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listCustomerTimelineHistoryEvents":         {"/api/admin/customer-timeline-history/events", "GET", "P4-V1-CUSTOMER-TIMELINE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_customer_timeline_history", "none", map[string]string{"admin": "global"}},
	"getCustomerTimelineHistoryEvent":           {"/api/admin/customer-timeline-history/events/{history_id}", "GET", "P4-V1-CUSTOMER-TIMELINE-HISTORY-2026-08-29", "admin.read", "human_session", "internal_pii", "contact.read_only_v1_customer_timeline_history", "none", map[string]string{"admin": "global"}},
	"getCampaignHistorySegment":                 {"/api/admin/campaign-history/segments/{segment_history_id}", "GET", "P4-V1-CAMPAIGN-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listCampaignHistoryMembers":                {"/api/admin/campaign-history/members", "GET", "P4-V1-CAMPAIGN-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listCampaignHistoryBroadcastPlans":         {"/api/admin/campaign-history/broadcast-plans", "GET", "P4-V1-CAMPAIGN-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"getCampaignHistoryBroadcastPlan":           {"/api/admin/campaign-history/broadcast-plans/{plan_history_id}", "GET", "P4-V1-CAMPAIGN-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listCampaignHistoryBroadcastRecipients":    {"/api/admin/campaign-history/broadcast-plans/{plan_history_id}/recipients", "GET", "P4-V1-CAMPAIGN-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listCampaignHistoryBroadcastMessages":      {"/api/admin/campaign-history/broadcast-recipients/{recipient_history_id}/messages", "GET", "P4-V1-CAMPAIGN-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "campaign.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	...
	"listServicePeriodHistoryDefinitions":       {"/api/admin/service-period-history", "GET", "P4-V1-SERVICE-PERIOD-HISTORY-2026-08-28", "products.read", "human_session", "internal", "product.read_only_service_period_history", "none", map[string]string{"admin": "global", "ops": "global"}},
	"listServicePeriodHistoryEntitlements":      {"/api/admin/service-period-history/{definition_id}/entitlements", "GET", "P4-V1-SERVICE-PERIOD-HISTORY-2026-08-28", "entitlements.read", "human_session", "internal_pii", "product.read_only_service_period_history", "none", map[string]string{"admin": "global", "ops": "global"}},
	"listServicePeriodHistoryEvents":            {"/api/admin/service-period-history/{definition_id}/events", "GET", "P4-V1-SERVICE-PERIOD-HISTORY-2026-08-28", "entitlements.read", "human_session", "internal_pii", "product.read_only_service_period_history", "none", map[string]string{"admin": "global", "ops": "global"}},
	"listCouponHistoryDefinitions":              {"/api/admin/coupon-history", "GET", "P4-V1-COUPON-HISTORY-2026-08-28", "coupons.read", "human_session", "internal", "coupon.read_only_v1_history", "none", map[string]string{"admin": "global", "ops": "global"}},
	"listMessageHistory":                        {"/api/admin/message-history", "GET", "P4-V1-MESSAGE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "wecom.read_only_v1_message_history", "none", map[string]string{"admin": "global"}},
	"getMessageHistory":                         {"/api/admin/message-history/{history_id}", "GET", "P4-V1-MESSAGE-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "wecom.read_only_v1_message_history", "none", map[string]string{"admin": "global"}},
	"listCouponHistoryClaims":                   {"/api/admin/coupon-history/{coupon_id}/claims", "GET", "P4-V1-COUPON-HISTORY-2026-08-28", "coupons.read", "human_session", "internal_pii", "coupon.read_only_v1_history", "none", map[string]string{"admin": "global", "ops": "global"}},
	"listCouponHistoryRedemptions":              {"/api/admin/coupon-history/{coupon_id}/redemptions", "GET", "P4-V1-COUPON-HISTORY-2026-08-28", "coupons.read", "human_session", "financial", "coupon.read_only_v1_history", "none", map[string]string{"admin": "global", "ops": "global"}},
	"listGroupOpsHistoryPlans":                  {"/api/admin/automation-conversion/group-ops/history/plans", "GET", "P4-V1-GROUPOPS-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "group_ops.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listGroupOpsHistoryDirectory":              {"/api/admin/automation-conversion/group-ops/history/directory", "GET", "P4-V1-GROUPOPS-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "group_ops.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listGroupOpsHistoryGroups":                 {"/api/admin/automation-conversion/group-ops/history/plans/{plan_id}/groups", "GET", "P4-V1-GROUPOPS-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "group_ops.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	"listGroupOpsHistoryNodes":                  {"/api/admin/automation-conversion/group-ops/history/plans/{plan_id}/nodes", "GET", "P4-V1-GROUPOPS-HISTORY-2026-08-28", "admin.read", "human_session", "internal_pii", "group_ops.read_only_v1_history", "none", map[string]string{"admin": "global"}},
	...
	"getWechatPayProductExternalPush":           {"/api/admin/wechat-pay/products/{product_id}/external-push", "GET", p4CommerceExternalPushEvidence, "products.read", "human_session", "financial", "product.external_push.local_configuration", "none", map[string]string{"admin": "global", "ops": "global"}},
	"saveWechatPayProductExternalPush":          {"/api/admin/wechat-pay/products/{product_id}/external-push", "PUT", p4CommerceExternalPushEvidence, "products.write", "human_session", "financial", "product.external_push.local_configuration", "required", map[string]string{"admin": "global", "ops": "global"}},
	"queueWechatPayProductExternalPushTest":     {"/api/admin/wechat-pay/products/{product_id}/external-push/test", "POST", p4CommerceExternalPushEvidence, "products.write", "human_session", "financial", "product.external_push.local_accepted_effect", "required", map[string]string{"admin": "global", "ops": "global"}},
	...
	"bootstrapSidebar":                          {"/api/sidebar/v2/bootstrap", "POST", p4SidebarLocalCoreEvidence, "customers.read", "optional_human_session", "internal_pii", "sidebar.local_read_model", "none", map[string]string{"admin": "global", "ops": "global", "sales": "owner_staff"}},
	...
	"getSidebarAgentConfig":                     {"/api/sidebar/v2/jssdk/agent-config", "GET", p4SidebarOAuthEvidence, "sidebar.jssdk", "public", "internal", "wecom.jsapi_and_agent_config_ticket.read", "none", nil},
	...
	"listCloudCampaignMembers":                  {"/api/admin/cloud-orchestrator/campaigns/{campaign_code}/members", "GET", "LEGACY-S07-082-MINIMAL-A-2026-08-29", "operations.read", "human_session", "internal", "campaign.latest_touch_plan_member_status.local_read_model", "none", map[string]string{"admin": "global", "ops": "global"}},
	...
	"listAIAudienceTemplates":                    {"/api/admin/ai-audience/templates", "GET", "LEGACY-S06-022-MINIMAL-A-2026-08-29", "segments.read", "human_session", "internal", "ai_audience.local_template_catalog", "none", map[string]string{"admin": "global", "ops": "global"}},
	"previewAIAudienceTemplate":                  {"/api/admin/ai-audience/packages/{package_id}/template-preview", "POST", "LEGACY-S06-022-MINIMAL-A-2026-08-29", "segments.read", "human_session", "internal", "ai_audience.local_template_preview", "none", map[string]string{"admin": "global", "ops": "global"}},
	"saveAIAudienceTemplateConfiguration":        {"/api/admin/ai-audience/packages/{package_id}/template-config", "PUT", "LEGACY-S06-022-MINIMAL-A-2026-08-29", "segments.write", "human_session", "internal", "ai_audience.local_template_transaction", "required", map[string]string{"admin": "global", "ops": "global"}},
	...
	"previewMediaContentPackage":                 {"/api/admin/content-packages/preview", "POST", p4MediaContentDeliveryEvidence, "media.library.write", "human_session", "internal", "media.content_delivery.local_validation", "required", map[string]string{"admin": "global", "ops": "global"}},
	"createMediaContentPackage":                  {"/api/admin/content-packages", "POST", p4MediaContentDeliveryEvidence, "media.library.write", "human_session", "internal", "media.content_delivery.local_command", "required", map[string]string{"admin": "global", "ops": "global"}},
	"updateMediaContentPackage":                  {"/api/admin/content-packages/{package_id}", "PUT", p4MediaContentDeliveryEvidence, "media.library.write", "human_session", "internal", "media.content_delivery.local_command", "required", map[string]string{"admin": "global", "ops": "global"}},
	"initiateMediaAttachmentMultipartUpload":     {"/api/admin/attachment-library/uploads", "POST", p4MediaContentDeliveryEvidence, "media.library.write", "human_session", "internal", "media.attachment_upload.local_private_storage", "required", map[string]string{"admin": "global", "ops": "global"}},
	"putMediaAttachmentMultipartPart":            {"/api/admin/attachment-library/uploads/{upload_id}/parts/{part_number}", "PUT", p4MediaContentDeliveryEvidence, "media.library.write", "human_session", "internal", "media.attachment_upload.local_private_storage", "required", map[string]string{"admin": "global", "ops": "global"}},
	"completeMediaAttachmentMultipartUpload":     {"/api/admin/attachment-library/uploads/{upload_id}/complete", "POST", p4MediaContentDeliveryEvidence, "media.library.write", "human_session", "internal", "media.attachment_upload.local_private_storage", "required", map[string]string{"admin": "global", "ops": "global"}},
	"getMediaContentDeliveryBinding":             {"/api/admin/campaigns/{campaign_code}/plans/{plan_id}/content-delivery-binding", "GET", p4MediaContentDeliveryEvidence, "media.library.read", "human_session", "internal", "media.content_delivery.local_binding_projection", "none", map[string]string{"admin": "global", "ops": "global"}},
	"createMediaContentDeliveryBinding":          {"/api/admin/campaigns/{campaign_code}/plans/{plan_id}/content-delivery-binding", "POST", p4MediaContentDeliveryEvidence, "media.library.write", "human_session", "internal", "media.content_delivery.local_binding_command", "required", map[string]string{"admin": "global", "ops": "global"}},
	"updateMediaContentDeliveryBinding":          {"/api/admin/campaigns/{campaign_code}/plans/{plan_id}/content-delivery-binding", "PUT", p4MediaContentDeliveryEvidence, "media.library.write", "human_session", "internal", "media.content_delivery.local_binding_command", "required", map[string]string{"admin": "global", "ops": "global"}},
	...
	"getAIAudienceConfigurationVersion":          {"/api/admin/ai-audience/packages/{package_id}/configuration", "GET", p4AIAudienceConfigurationClosureEvidence, "segments.read", "human_session", "internal", "ai_audience.configuration_versions.local_read_model", "none", map[string]string{"admin": "global", "ops": "global"}},
	"putAIAudienceConfigurationVersion":          {"/api/admin/ai-audience/packages/{package_id}/configuration", "PUT", p4AIAudienceConfigurationClosureEvidence, "segments.write", "human_session", "internal", "ai_audience.configuration_versions.local_transaction", "required", map[string]string{"admin": "global", "ops": "global"}},
	"previewAIAudienceConfiguration":             {"/api/admin/ai-audience/packages/{package_id}/configuration-preview", "GET", p4AIAudienceConfigurationClosureEvidence, "segments.read", "human_session", "internal", "ai_audience.configuration_versions.local_evaluation", "none", map[string]string{"admin": "global", "ops": "global"}},
	"materializeAIAudienceConfiguration":         {"/api/admin/ai-audience/packages/{package_id}/configuration-materialize", "POST", p4AIAudienceConfigurationClosureEvidence, "segments.write", "human_session", "internal", "ai_audience.configuration_versions.local_transaction", "required", map[string]string{"admin": "global", "ops": "global"}},
}
...
var p4APIClientOAuthOperations = map[string]bool{
	"issueAPIClientToken": true,
}
...
func validateContracts(doc *openapi3.T, inventory mappingInventory, validateOpenAPI bool) error {
	...
	seenP4Automation, seenP4APIClientOAuth, seenP4HXCSenderManagement, seenP4AutomationAgent, seenP4AutomationAgentManagement, seenP4Customer360, seenP4Product, seenP4ServicePeriodLifecycle, seenP4ServicePeriodMemberGridRead, seenP4MemberGridManagement, seenP4Radar, seenP4CloudCampaign, seenP4AIAudience, seenP4Media, seenP4GroupInvite, seenP4Survey, seenP4Channel, seenP4Tag, seenP4TagAB, seenP4Coupon, seenP4Order, seenP4CustomerCompat, seenP4ConfigSettings, seenP4SetupWizard, seenP4DomainVerification, seenP4PushCenter, seenP4ExecutionRuntime, seenP4AdminShell, seenP4LegacyHealth := map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}, map[string]bool{}
	...
	for path, item := range doc.Paths.Map() {
		for _, op := range item.Operations() {
			...
			} else if p4APIClientOAuthOperations[op.OperationID] {
				seenP4APIClientOAuth[op.OperationID] = true
				if path != "/oauth/token" || op.Extensions["x-p4-decision-evidence"] != p4APIClientOAuthEvidence ||
					op.Extensions["x-aicrm-capability"] != "api_client.token.issue" || op.Extensions["x-aicrm-auth-scheme"] != "oauth2_client_credentials" ||
					op.Extensions["x-aicrm-csrf"] != "none" || op.Extensions["x-aicrm-data-classification"] != "secret" ||
					op.Extensions["x-aicrm-data-source"] != "admin_ops_credential_and_environment_secret_map" || op.Extensions["x-aicrm-external-effect"] != "none" ||
					op.Security == nil || len(*op.Security) != 0 || op.Responses.Value("200") == nil || op.Responses.Value("400") == nil || op.Responses.Value("401") == nil ||
					op.Responses.Value("403") == nil || op.Responses.Value("405") == nil || op.Responses.Value("503") == nil {
					return fmt.Errorf("%s API-client OAuth boundary drifted", op.OperationID)
				}
			...
			if p4APIClientOAuthOperations[op.OperationID] || p4DomainVerificationOperations[op.OperationID] || p4LegacyHealthOperations[op.OperationID] || p4RadarPublicOperations[op.OperationID] || nativePackageOperationDeclared(op.OperationID) || pe01OperationDeclared(op.OperationID) || commerceRefundOperationDeclared(op.OperationID) {
	...
	for id := range p4APIClientOAuthOperations {
		if !seenP4APIClientOAuth[id] {
			return fmt.Errorf("missing P4 API-client OAuth operation: %s", id)
		}
	}
