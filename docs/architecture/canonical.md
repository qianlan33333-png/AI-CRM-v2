...
固定工具链：Go 1.26.5、Node 24.18.0 LTS、npm 11.12.1、PostgreSQL 16.14。初始依赖锁定为 River 0.24.0、pgx 5.7.5、chi 5.2.3、oapi-codegen 2.6、sqlc 1.28、Goose 3.25、React 18.3.1、antd 5.27.6、Orval 7.13、Vite 7.2.2。版本变更必须单独评审，不能由业务 Slice 顺手升级。
