...
func TestCandidateServerIsNotTheRuntimeServer(t *testing.T) {
	...
	assertMethodNames(t, "candidate server", reflect.TypeOf((*generated.StrictServerInterface)(nil)).Elem(), []string{
		...
		"ClearUserOpsCustomerDnd", "CreateUserOpsLocalPlan", "GetUserOpsCustomerDetail", "GetUserOpsOverview", "ListUserOpsCustomers", "ListUserOpsSendRecords", "PreviewUserOpsBatch", "PreviewUserOpsSafeExport", "SetUserOpsCustomerDnd",
